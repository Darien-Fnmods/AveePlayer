...
public class AppPermissions {
    ...
    public static void isStoragePermissionGranted(Context context, Activity activity) {
    ...
    public static void is_RecordAudio_PermissionGranted(Context context, Activity activity) {
